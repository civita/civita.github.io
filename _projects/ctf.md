...
description: A write-up of my approach to solving selected CTF challenges, including HITCON CTF 2018.
importance: 4
category: school
...
{% include figure.html path="https://i.imgur.com/C0AtDcf.png" width="700" class="img-fluid rounded z-depth-1" %}
- Step 0x01
...
{% include figure.html path="https://i.imgur.com/zrHsOEj.png" width="700" class="img-fluid rounded z-depth-1" %}
...
{% include figure.html path="https://i.imgur.com/QOigDYh.png" width="700" class="img-fluid rounded z-depth-1" %}
So my payload is `'A' * 136 + (pointer_to_buf) + (buf_size)`
- Step 0x02
After step 0x01, we are able to re-write the return address without error.
{% include figure.html path="https://i.imgur.com/qsy78Wv.png" width="700" class="img-fluid rounded z-depth-1" %}
...
{% include figure.html path="https://i.imgur.com/AgBgEDz.png" width="700" class="img-fluid rounded z-depth-1" %}
...
{% include figure.html path="https://i.imgur.com/ylRj2Wu.png" width="700" class="img-fluid rounded z-depth-1" %}

{% include figure.html path="https://i.imgur.com/f5Z9S5A.png" width="700" class="img-fluid rounded z-depth-1" %}
...
{% include figure.html path="https://i.imgur.com/jQl7aeg.png" width="700" class="img-fluid rounded z-depth-1" %}
...
{% include figure.html path="https://i.imgur.com/LaRqPxR.png" width="700" class="img-fluid rounded z-depth-1" %}
...
{% include figure.html path="https://i.imgur.com/lePubEJ.png" width="700" class="img-fluid rounded z-depth-1" %}
...
{% include figure.html path="https://i.imgur.com/3HPwG2W.png" width="700" class="img-fluid rounded z-depth-1" %}
- **Step 0x01**
...
{% include figure.html path="https://i.imgur.com/QzJC5K1.png" width="700" class="img-fluid rounded z-depth-1" %}
...
{% include figure.html path="https://i.imgur.com/ticStTi.png" width="700" class="img-fluid rounded z-depth-1" %}
...
{% include figure.html path="https://i.imgur.com/1JhDioF.png" width="700" class="img-fluid rounded z-depth-1" %}
I used `gdb` again, and the following picture indicates the parameters on the stack. The parameters from $5^{th}$ start at `$rsp`.
{% include figure.html path="https://i.imgur.com/iLQBp4g.png" width="700" class="img-fluid rounded z-depth-1" %}
...
{% include figure.html path="https://i.imgur.com/ROgwHwT.png" width="700" class="img-fluid rounded z-depth-1" %}
- **Step 0x03**
{% include figure.html path="https://i.imgur.com/HNALuBR.png" width="700" class="img-fluid rounded z-depth-1" %}
...
{% include figure.html path="https://i.imgur.com/cegDTi7.png" width="700" class="img-fluid rounded z-depth-1" %}
...
{% include figure.html path="https://i.imgur.com/ZG0BRCd.png" width="700" class="img-fluid rounded z-depth-1" %}
My strategies are:
...
{% include figure.html path="https://i.imgur.com/pNvU9qu.png" width="700" class="img-fluid rounded z-depth-1" %}
...
{% include figure.html path="https://i.imgur.com/0qJpZZ2.png" width="700" class="img-fluid rounded z-depth-1" %}
Fortunately, we can decompress it without a hassle by using `UPX -d` option.
{% include figure.html path="https://i.imgur.com/bS8UZ9A.png" width="700" class="img-fluid rounded z-depth-1" %}
- Step 0x01
...
{% include figure.html path="https://i.imgur.com/qRsrbBR.png" width="700" class="img-fluid rounded z-depth-1" %}
This string ends at `0x4c6ae0`:
{% include figure.html path="https://i.imgur.com/zYEzV30.png" width="700" class="img-fluid rounded z-depth-1" %}
- Step 0x03
...
{% include figure.html path="https://i.imgur.com/rdMMcsh.png" width="700" class="img-fluid rounded z-depth-1" %}
- Step 0x04
{% include figure.html path="https://i.imgur.com/mT8zBme.png" width="700" class="img-fluid rounded z-depth-1" %}
...
{% include figure.html path="https://i.imgur.com/5bE2as7.png" width="700" class="img-fluid rounded z-depth-1" %}
- Step 0x05
...
- Step 0x06
{% include figure.html path="https://i.imgur.com/4hkEEHr.png" width="700" class="img-fluid rounded z-depth-1" %}
...
- Step 0x07
{% include figure.html path="https://i.imgur.com/JMV5bLv.png" width="700" class="img-fluid rounded z-depth-1" %}
...
```
- **Step 0x02**
{% include figure.html path="https://i.imgur.com/mgupIrw.png" width="700" class="img-fluid rounded z-depth-1" %}
...
{% include figure.html path="https://i.imgur.com/WB6PN5Z.png" width="700" class="img-fluid rounded z-depth-1" %}
    2. Use Firefox with Hackbar to send the upload request. Note that we should set `action[0]` instead of `action`.
{% include figure.html path="https://i.imgur.com/V7BP8tV.png" width="700" class="img-fluid rounded z-depth-1" %}
    3. Copy the uploaded GIF url.
{% include figure.html path="https://i.imgur.com/ai1b9Iq.png" width="700" class="img-fluid rounded z-depth-1" %}
...
{% include figure.html path="https://i.imgur.com/5Obk0xe.png" width="700" class="img-fluid rounded z-depth-1" %}
- **Step 0x04**
    1. Now, we are able to do RCE by calling our evil `php` and set `1` to the system command we want to call:
{% include figure.html path="https://i.imgur.com/QHZjQDI.png" width="700" class="img-fluid rounded z-depth-1" %}
    2. I found a file named `fl49` in the root directory:
{% include figure.html path="https://i.imgur.com/mTL1ZS4.png" width="700" class="img-fluid rounded z-depth-1" %}
    3. *Whoa!* Here is the flag.
{% include figure.html path="https://i.imgur.com/M3kdTLm.png" width="700" class="img-fluid rounded z-depth-1" %}
...
{% include figure.html path="https://i.imgur.com/7t9oBBb.png" width="700" class="img-fluid rounded z-depth-1" %}
...
{% include figure.html path="https://i.imgur.com/zT6X1zZ.png" width="700" class="img-fluid rounded z-depth-1" %}
In package No. 299, there is another character, ==i==, in it.
{% include figure.html path="https://i.imgur.com/ZREb5Q2.png" width="700" class="img-fluid rounded z-depth-1" %}
...
{% include figure.html path="https://i.imgur.com/z9z14wZ.png" width="700" class="img-fluid rounded z-depth-1" %}
...
{% include figure.html path="https://i.imgur.com/IDU1g62.png" width="700" class="img-fluid rounded z-depth-1" %}
...
{% include figure.html path="https://i.imgur.com/C3OrqZ0.png" width="700" class="img-fluid rounded z-depth-1" %}
9. After that, we are able to draw a table to illustrate my conclusion and based on the packages we've found:

{% include figure.html path="https://i.imgur.com/4ZuC9D9.png" width="700" class="img-fluid rounded z-depth-1" %}
